...
export class RequestQueue {
   ...
   */
  getStats(): QueueStats {
    const avgWaitTime = this.stats.completed > 0 ? this.stats.totalWaitTime / this.stats.completed : 0;

    const avgProcessTime = this.stats.completed > 0 ? this.stats.totalProcessTime / this.stats.completed : 0;
